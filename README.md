...
**En production** : https://capweb-b4.vercel.app — TriMalin ♻️, assistant tri et recyclage. La version en ligne est donnée par [`/version.json`](https://capweb-b4.vercel.app/version.json).

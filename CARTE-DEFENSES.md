...
| Secret exposé | Clé seulement dans les variables Vercel, appel au modèle uniquement dans `server/ia.js`, et un test qui relit tous les fichiers de `public/js/` | https://github.com/capweb-2026/capweb-b4/pull/10 et son run https://github.com/capweb-2026/capweb-b4/actions/runs/35516561651 : run rouge à l'étape `npm test`, sur le test « aucun fichier de public/ ne contient de clé ni d'adresse de passerelle ». Fausse clé, PR fermée sans fusion, aucune preview déployée | CP3 |
